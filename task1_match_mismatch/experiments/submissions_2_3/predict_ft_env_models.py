...
if __name__ == '__main__':
    ...
    models_dir = './task1_match_mismatch/experiments/results_submission_3/finetuned_env_models/'
    ...
    for sub_path in test_data:
        ...
        prediction_dir = os.path.join(os.path.dirname(__file__), '../', 'results_submission_2', 'heldout_predictions_finetuned_env')
