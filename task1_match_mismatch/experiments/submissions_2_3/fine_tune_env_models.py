...
if __name__ == "__main__":
    ...
    results_folder = os.path.join(experiments_folder, "results_submission_3", "finetuned_env_models")
    ...
    for subject in subjects:
        ...
        #load dilation model
        model_path = os.path.join(results_folder, "../", "population_env_model", "population_env_model.h5")
