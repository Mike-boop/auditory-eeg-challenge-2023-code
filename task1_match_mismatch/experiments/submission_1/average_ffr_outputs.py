...
def get_predictions(model, test_dict):
    ...
    for recording, ds_test in test_dict.items():
        ...
        np.savez(f'./task1_match_mismatch/experiments/results_submission_1/test_predictions_avg_ffr/{recording}_predictions.npz', predictions=predictions, targets=targets)
