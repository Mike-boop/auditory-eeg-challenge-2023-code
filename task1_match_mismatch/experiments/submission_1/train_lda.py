...
def get_preds_targets_for_split(split='test', sub=None):
    ...
    ffr_filenames = [f.replace(f'test_predictions_avg_baseline', 'test_predictions_avg_ffr') for f in env_filenames]
...
if __name__ == '__main__':
    ...
    val_predictions, val_targets = get_preds_targets_for_split('val')
    ...
    pickle.dump(lda, open('./task1_match_mismatch/experiments/results_submission_1/lda_models/fitted_pop_lda.pkl', 'wb'))
