...
if __name__ == "__main__":
    ...
    results_folder = os.path.join(experiments_folder, "results_submission_4", "finetuned_env_models")
    ...
    for subject in subjects:
        ...
        #load dilation model
        model_path = os.path.join(results_folder, "../../", "results_submission_3", "population_env_model", "population_env_model.h5")
        ...
        train_generator = MatchMismatchDataGenerator(train_files, window_length, spacing=spacing, randomise=True, mismatch_pre_post=True)
        dataset_train = create_tf_dataset(train_generator, window_length, default_batch_equalizer_fn, train_hop_length, batch_size, feature_dims=(64, stimulus_dimension, stimulus_dimension), randomise=True)
        ...
        dataset_val = create_tf_dataset(val_generator, window_length, default_batch_equalizer_fn, val_hop_len, batch_size, feature_dims=(64, stimulus_dimension, stimulus_dimension))
